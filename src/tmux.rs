...
pub use options::{
    ...
    SIDEBAR_COLOR_IDLE, SIDEBAR_COLOR_PORT, SIDEBAR_COLOR_PR_LINK, SIDEBAR_COLOR_RESPONSE_ARROW,
    ...
    SIDEBAR_NOTIFICATIONS_EVENTS, SIDEBAR_PID, SIDEBAR_REPO_FILTER, SIDEBAR_WIDTH,
